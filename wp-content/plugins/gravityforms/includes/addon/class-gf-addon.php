...
abstract class GFAddOn {
	...
	public function get_field_value( $form, $entry, $field_id ) {
		...
		return apply_filters( "gform_{$slug}_field_value_{$form['id']}_{$field_id}", apply_filters( "gform_{$slug}_field_value_{$form['id']}", apply_filters( "gform_{$slug}_field_value", $field_value, $form, $entry, $field_id ), $form, $entry, $field_id ), $form, $entry, $field_id );
